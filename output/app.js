import { host } from '../interface/host.mjs';
...
function trampoline23(arg0, arg1, arg2, arg3) {
  ...
  const ret = rsc0.getStorage(result3);
  rsc0[symbolRscHandle] = null;
...
function trampoline24(arg0, arg1, arg2, arg3, arg4) {
  ...
  rsc0.setStorage(result3, result4);
  rsc0[symbolRscHandle] = null;
}
...
function trampoline26(arg0, arg1) {
  ...
  let ret;
  try {
    ret = { tag: 'ok', val: rsc0.getConnection()};
  } catch (e) {
    ret = { tag: 'err', val: getErrorPayload(e) };
  }
  rsc0[symbolRscHandle] = null;
...
function test(arg0) {
  ...
  const ret = exports1.test(handle0);
...
const $init = (async() => {
  const module0 = fetchCompile(new URL('./app.core.wasm', import.meta.url));
  const module1 = fetchCompile(new URL('./app.core2.wasm', import.meta.url));
  const module2 = base64Compile('');
  const module3 = base64Compile('');
  ({ exports: exports0 } = await instantiateCore(await module2));
  ({ exports: exports1 } = await instantiateCore(await module0, {
    'app:fortnox/host@0.0.1': {
      '[method]context.get-connection': exports0['9'],
      '[method]context.get-input': exports0['8'],
      '[method]context.get-storage': exports0['6'],
      '[method]context.set-storage': exports0['7'],
      '[resource-drop]context': trampoline7,
    },
    ...
    wasi_snapshot_preview1: {
      clock_res_get: exports0['27'],
      clock_time_get: exports0['28'],
      fd_fdstat_get: exports0['29'],
  ...
  ({ exports: exports2 } = await instantiateCore(await module1, {
    ...
    'wasi:cli/terminal-input@0.2.0': {
      '[resource-drop]terminal-input': trampoline15,
    },
    'wasi:cli/terminal-output@0.2.0': {
      '[resource-drop]terminal-output': trampoline16,
    },
    ...
    'wasi:clocks/monotonic-clock@0.2.0': {
      now: trampoline4,
      resolution: trampoline8,
    },
    'wasi:clocks/wall-clock@0.2.0': {
      now: exports0['11'],
      resolution: exports0['12'],
    },
  ...
  ({ exports: exports3 } = await instantiateCore(await module3, {
    '': {
      ...
      '27': exports2.clock_res_get,
      '28': exports2.clock_time_get,
      '29': exports2.fd_fdstat_get,
      '3': trampoline20,
      '4': trampoline21,
      '5': trampoline22,
      '6': trampoline23,
  ...
  postReturn0 = exports1.cabi_post_test;
})();
